// ════════════════════════════════════════════════════
//  학생 입장 잠금 (student-guard.js) — my-page.html 전용
// ════════════════════════════════════════════════════
//  쓰는 법: my-page.html <head> 안에 firebase-config.js 다음 줄에 추가
//    <script src="student-guard.js"></script>
//
//  비밀번호를 바꾸려면 (매달 새 챌린지 시작할 때 함께 바꾸세요):
//    터미널에서  printf '새비번' | shasum -a 256
//    나온 값을 아래 PASS_HASH 에 붙여넣고, MONTH_KEY 도 새 챌린지 월로 바꾸기
//    → MONTH_KEY 를 바꾸면 이전 달에 입장했던 학생도 새 비번을 다시 입력하게 됨
//
//  ⚠️ 저장소가 공개라 작정하고 파고들면 우회할 수 있습니다.
//     신청 안 한 사람이 우연히/호기심에 들어오는 것을 막는 용도입니다.
// ════════════════════════════════════════════════════
